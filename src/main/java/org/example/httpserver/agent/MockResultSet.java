...
public class MockResultSet implements ResultSet {
    ...
    public void close() throws SQLException {
        // No actual resources to close in this mock
    }
    ...
    public int getInt(String columnLabel) throws SQLException {
        ...
        throw new SQLException("Column '" + columnLabel + "' is not an integer.");
    }
    ...
    public long getLong(String columnLabel) throws SQLException {
        ...
        throw new SQLException("Column '" + columnLabel + "' is not a long.");
    }
    ...
    public float getFloat(String columnLabel) throws SQLException {
        ...
        throw new SQLException("Column '" + columnLabel + "' is not a float.");
    }
    ...
    public double getDouble(String columnLabel) throws SQLException {
        ...
        throw new SQLException("Column '" + columnLabel + "' is not a double.");
    }
    ...
    // ... Implementations for other getXXX() methods (similar to above) ...
    ...
    public Object getObject(String columnLabel) throws SQLException {
        if (isClosed() || currentRowIndex < 0 || currentRowIndex >= data.size()) {
            return null;
        }
        return data.get(currentRowIndex).get(columnLabel);
    }
    ...
    // ... (All other unimplemented ResultSet methods) ...
    ...
    // ... (The rest of the unimplemented ResultSet methods) ...
